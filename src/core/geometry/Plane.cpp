...
Plane::Plane (glm::vec3 normal, double intersect, const Material* material) : normal{std::move(glm::normalize(normal))}, intersect{intersect}, material(material) {}
...
Plane Plane::from_three_points (const glm::vec3& t1, const glm::vec3& t2, const glm::vec3& t3, const Material* material) {
